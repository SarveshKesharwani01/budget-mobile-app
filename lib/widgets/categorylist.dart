...
class _CategoryState extends State<Category> {
  ...
  Widget getList(Add_data history, int index) {
    return get(index, history) != ListTile
        ? Dismissible(
            key: UniqueKey(),
  ...
  Widget getList1(Add_data history, int index) {
    return get1(index, history) != ListTile
        ? Dismissible(
            key: UniqueKey(),
            onDismissed: (direction) {
              history.delete();
            },
            child: get1(index, history))
        : SizedBox(
            height: 1,
          );
  }
  ...
  Widget getList2(Add_data history, int index) {
    return get2(index, history) != ListTile
        ? Dismissible(
            key: UniqueKey(),
            onDismissed: (direction) {
              history.delete();
            },
            child: get2(index, history))
        : SizedBox(
            height: 1,
          );
  }
  ...
  Widget getList3(Add_data history, int index) {
    return get3(index, history) != ListTile
        ? Dismissible(
            key: UniqueKey(),
            onDismissed: (direction) {
              history.delete();
            },
            child: get3(index, history))
        : SizedBox(
            height: 1,
          );
  }
